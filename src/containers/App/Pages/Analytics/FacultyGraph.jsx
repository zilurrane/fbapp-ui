...
class FacultyGraph extends Component {
  static propTypes = {
    ...
    isFacultyFeedbackLoading: PropTypes.bool.isRequired,
    isFacultiesFeedbackSummaryLoading: PropTypes.bool.isRequired,
  };
  ...
  render() {
    const {
      ...
      isFacultyFeedbackLoading,
      isFacultiesFeedbackSummaryLoading,
    } = this.props;
    return (
      <Fragment>
        <Row className="faculty-comparison-container">
            ...
            <div className="responsive-barchart-container">
              {
                isFacultyFeedbackLoading ?
                  ...
                  :
                  facultyFeedback && facultyFeedback.length === 0 ?
                    <AppEmpty />
                    :
          ...
          <Col sm={{ span: 5, offset: 1 }} xs={24}>
            <List
              ...
              loading={{ spinning: isFacultiesFeedbackSummaryLoading, indicator: AppLoaderIndicator }}
              renderItem={item => (
                <List.Item>
                  <List.Item.Meta
